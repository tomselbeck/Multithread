...
m.addSeparator()
m.addCommand('Match selection position - animated', 'animatedSnap3D.translateThisNodeToPointsAnimated()')
m.addCommand('Match selection position, orientation - animated', 'animatedSnap3D.translateRotateThisNodeToPointsAnimated()')
m.addCommand('Match selection position, orientation, size - animated', 'animatedSnap3D.translateRotateScaleThisNodeToPointsAnimated()')
